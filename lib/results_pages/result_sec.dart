...
class ResultSecretary extends StatefulWidget {
  const ResultSecretary({super.key});

  @override
  State<ResultSecretary> createState() => _ResultSecretaryState();
}

class _ResultSecretaryState extends State<ResultSecretary> {
  List candidates = [];
