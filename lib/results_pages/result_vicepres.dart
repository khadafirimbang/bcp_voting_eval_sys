...
class ResultVicePres extends StatefulWidget {
  const ResultVicePres({super.key});

  @override
  State<ResultVicePres> createState() => _ResultVicePresState();
}

class _ResultVicePresState extends State<ResultVicePres> {
  List candidates = [];
          ...
          if (data['status'] == 'ongoing') {
            if ((data['candidates'] as List).isNotEmpty) {
              candidates = (data['candidates'] as List)
                  .where((candidate) => candidate['position'] == 'Vice President')
                  .toList();
