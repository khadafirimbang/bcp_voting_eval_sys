...
class ResultTreasurer extends StatefulWidget {
  const ResultTreasurer({super.key});

  @override
  State<ResultTreasurer> createState() => _ResultTreasurerState();
}

class _ResultTreasurerState extends State<ResultTreasurer> {
  List candidates = [];
