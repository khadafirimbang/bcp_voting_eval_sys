...
class ProfileMenuVoter extends StatefulWidget {
  @override
  _ProfileMenuVoterState createState() => _ProfileMenuVoterState();
}

class _ProfileMenuVoterState extends State<ProfileMenuVoter> {
  ...
  Widget build(BuildContext context) {
    return buildProfileMenuVoter(context, studentNo);
  }

  Widget buildProfileMenuVoter(BuildContext context, String? studentNo) {
